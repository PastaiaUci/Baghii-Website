...
const Services = () => {
    return (
        <div className="container mx-auto my-12 px-4 lg:px-10 lg:max-w-screen-2xl mt-[110px]" data-aos="fade-up">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 mb-16" data-aos="fade-up">
                ...
                <div className="order-1 lg:order-2 flex justify-center items-center" data-aos="fade-left">
                    <img src={webDevImg} alt="Web Development" className="w-full lg:w-2/3 rounded-lg shadow-lg" />
                </div>
            </div>

            {/* Expert Video Editing */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 mb-16" data-aos="fade-up">
                <div className="order-1 flex justify-center items-center" data-aos="fade-right">
                    <img src={videoEditingImg} alt="Video Editing" className="w-full lg:w-2/3 rounded-lg shadow-lg" />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 mb-16" data-aos="fade-up">
                ...
                <div className="order-1 lg:order-2 flex justify-center items-center" data-aos="fade-left">
                    <img src={printingImg} alt="3D Printing" className="w-full lg:w-2/3 rounded-lg shadow-lg" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 mb-16" data-aos="fade-up">
                <div className="order-1 flex justify-center items-center" data-aos="fade-right">
                    <img src={modelingImg} alt="3D Modeling" className="w-full lg:w-2/3 rounded-lg shadow-lg" />
                </div>
                <div className="order-2 flex items-center">
                    <div>
                        <h2 className="text-3xl font-bold text-blue-900">Precision 3D Modeling</h2>
                        <p className="text-lg text-gray-700 mt-4 leading-relaxed">
                            Our 3D modeling services are ideal for creating custom parts or any design you envision. With an engineer on our team who has extensive experience in the automotive industry, 
                            we bring a level of precision and technical expertise that ensures every model is accurate and intricately detailed. From complex mechanical components to artistic designs, we deliver models suitable for a wide range of applications, 
                            helping you visualize, refine, and perfect your ideas before they come to life. With our industry knowledge and attention to detail, you can trust us to turn your vision into a flawless, functional reality.
                        </p>
                    </div>
                </div>
            </div>
